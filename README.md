  ...
  function() {
    ...
    cprequire(
      ...
      function(myWorkspaceRobitnTinyg) {
        ...
        console.log("Workspace / TinyG just got loaded.", myWorkspaceRobitnTinyg);
